...
/** @date	2015-02-19
    ...
    @info
			...
			buttons.val[0]:  | 7| 6| 5| 4| 3| 2| 1| 0
			buttons.val[1]:  |15|14|13|12|11|10| 9| 8
*******************************************************************************/
#include <stdint.h>
#include "fnl.h"
...
#define FNL_NUM_OUT_REGS 	4
#define FNL_NUM_IN_REGS 	2
#define FNL_PORT			6
#define FNL_DEVICE_LEDS		1
#define FNL_DEVICE_BTNS 	2
...
static uint8_t buttonIds0[8] = {15,14,13,12,11,10, 9, 8};
static uint8_t buttonIds1[8] = { 7, 6, 5, 4, 3, 2, 1, 0};
...
void FNL_Init(void)
{
	...
	DBNC_Init(&btnDebounceByte0, 1, buttonIds0, FNL_MIDI_CH);
	DBNC_Init(&btnDebounceByte1, 1, buttonIds1, FNL_MIDI_CH);
}
...
/******************************************************************************/
/** @todo	change this to SetLedColor
*******************************************************************************/
...
{
	uint8_t cnt;
	for (cnt = 0; cnt < FNL_NUM_OUT_REGS; cnt++)
		leds.val[cnt] = 0x00;
}
...
/******************************************************************************/
/** @todo	this function could also use the buttonIdMap
*******************************************************************************/
static void Leds_SetSingle(uint8_t ledId)
{
	switch (ledId)
	{
		case  0: leds.val[0] |= 0b11 << 6; break;
		case  1: leds.val[0] |= 0b11 << 4; break;
		case  2: leds.val[0] |= 0b11 << 2; break;
		case  3: leds.val[0] |= 0b11 << 0; break;

		case  4: leds.val[1] |= 0b11 << 6; break;
		case  5: leds.val[1] |= 0b11 << 4; break;
		case  6: leds.val[1] |= 0b11 << 2; break;
		case  7: leds.val[1] |= 0b11 << 0; break;

		case  8: leds.val[2] |= 0b11 << 6; break;
		case  9: leds.val[2] |= 0b11 << 4; break;
		case 10: leds.val[2] |= 0b11 << 2; break;
		case 11: leds.val[2] |= 0b11 << 0; break;

		case 12: leds.val[3] |= 0b11 << 6; break;
		case 13: leds.val[3] |= 0b11 << 4; break;
		case 14: leds.val[3] |= 0b11 << 2; break;
		case 15: leds.val[3] |= 0b11 << 0; break;
